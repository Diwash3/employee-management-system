...
public class Print_Details extends Application {
        static Stage stg7;
        String eid;
        String name, fname, address, phone, email, education, designation, age, dob, aadhar;
        ...
        public void start(Stage stage7) throws Exception {
                ...
                Label l91 = new Label(designation);
