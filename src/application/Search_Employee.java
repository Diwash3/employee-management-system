...
public class Search_Employee extends Application {
		...
		public void start(Stage stage7) throws Exception {
	            ...
	            VBox vbox=new VBox();
	           vbox.setSpacing(40);
	           Image img=new Image("https://img.freepik.com/premium-vector/minimal-we-are-hiring-background-job-vacancy-concept_90099-531.jpg?w=1060");
 ...
 l1.setFont(Font.font("Time New Roman",FontWeight.BOLD,20));
  ...
  search.setStyle("-fx-Background-color:#000000;-fx-text-fill:#ffffff;");  hbox2.setMargin(search,new Insets(0,10,0,120));
