...
public class Remove_Employee extends Application {
    ...
    public void start(Stage stage6) throws Exception {
        ...
        VBox vbox2 = new VBox();
        Image img = new Image(
                "https://thumbs.dreamstime.com/b/template-text-virtual-screen-background-icons-business-internet-technology-networking-concept-template-text-122092964.jpg");
